...
export const homeFilms = {
  ...
  /** The main site's celebration reel, playing silently behind the section. */
  ambient: {
  ...
  films: [
    ...
    },
    {
      ...
      // "SHOW REEL.mp4" (the /view page's title). Drive offers no thumbnail, so
      // the poster is a frame from the celebration reel above.
      title: 'Show Reel',
